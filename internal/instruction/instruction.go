...
type Pattern struct {
	...
	GetImmediate          func(instructions []byte, i int, ins *Instruction) int16
...
var Table = []*Pattern{
	...
	func() *Pattern {
		...
		p.GetImmediate = func(_ []byte, _ int, _ *Instruction) int16 { return 0 }
	...
	func() *Pattern {
		...
		p.GetImmediate = func(instructions []byte, i int, ins *Instruction) int16 {
			idx := 0
			switch ins.Mod {
			case 0b00:
				if ins.RM == 0b110 {
